...
public class SupporterUI : MonoBehaviour
{
    ...
    public GameObject mainImageBackground;
    ...
    private void ShowPreview(SupporterData data, bool isJoinedState)
    {
        ...
        if (data == null)
        {
            ...
            if (mainImageBackground != null) mainImageBackground.SetActive(false);
        ...
        else
        {
            ...
            if (mainImageBackground != null) mainImageBackground.SetActive(true);
